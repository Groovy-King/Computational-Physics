...
# Since we know that E_ground lies between 100 and 200 eV, we use these as our bracketing guesses
E_guess1 = 100*e
E_guess2 = 200*e

E_ground = Root_finder(psi_right, E_guess1, E_guess2, method = 'Secant', TOL_Parameter = 'Relative')

print(f"\nThe Ground State Energy of the given Harmonic Oscillator is: {E_ground/e} eV")
...
print(f"The First Excited State Energy of the given Harmonic Oscillator is: {E_first_excited/e} eV")
...
print(f"The Second Excited State Energy of the given Harmonic Oscillator is: {E_second_excited/e} eV")
