...
from Import_Modules.Integration import num_int, Simpson_Error
...
for i in np.arange(1, 15):
    x = np.linspace(0, 1, 2**i + 1) # To get n slices, we need n + 1 points
    y = f(x)
    I = num_int(x, y, method = 'Simpson')
    err, I1, I2 = Simpson_Error(f, 0, 1, 2**i)
